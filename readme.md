...
| ------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| cli     | `deno`         | `deno install --unstable -f -A -n rad https://raw.githubusercontent.com/cdaringe/rad/v6.3.0/src/bin.ts`                                                                                                                         |
...
| library | `deno`         | `import * as rad from https://github.com/cdaringe/rad/blob/main/v6.3.0/mod.ts`                                                                                                                                                  |
