...
| cli     | `curl`         | <code>curl -fsSL https://github.com/cdaringe/rad/releases/download/v6.3.0-next.3/install.sh \| sh</code> (versioned)<br /><code>curl -fsSL https://raw.githubusercontent.com/cdaringe/rad/main/assets/install.sh \| sh</code> (latest) |
