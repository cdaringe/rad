...
A general purpose build tool. Terse, statically typed, batteries included. Command tasks, function tasks, and make-style tasks supported.
...
- productive toolkit API for nuanced tasks that benefit from programming. see [toolkit](#toolkit)<!-- @todo write toolkit docs-->
...
Read more on our [documentation site](https://cdaringe.github.io/rad/) <!--NOSITE-->
