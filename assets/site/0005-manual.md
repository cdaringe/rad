...
exec deno run --allow-read --allow-write --allow-net --allow-env --allow-run --allow-hrtime 'https://raw.githubusercontent.com/cdaringe/rad/v7.0.0/src/bin.ts' "$@"
```
...
deno  \
  ...
  'https://raw.githubusercontent.com/cdaringe/rad/v7.0.0/src/bin.ts' \
  test
